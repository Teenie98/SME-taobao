...
import argparse
import torch
from gen_model.MetaEmb import MetaEmb

from rec_model import device, set_seed, model_dict as rec_model_dict

model_dict = {'MetaEmb': MetaEmb}
def parse_args():
    parser = argparse.ArgumentParser()
    parser.add_argument('--model', type=str, default='MetaEmb', help='MetaEmb MWUF GME SME SME2 SME3')
...
if __name__ == '__main__':
    ...
    rec_model.load_state_dict(torch.load("../rec_model/save_p/{}_parameter.pkl".format(args.base_model)))
    ...
    if args.model == "MWUF":
        ...
        print('warm up training...')
        rec_model.warm_up_train(args.warm_up_batch_size, args.warm_up_learning_rate, 'item_id')
